        ...
        fourWay.find('.row').each(function (i) {
            ...
            $(this).find('.selectionsAndOdds').each(function (n) {
                if (arrayOfMatchOdds[i + 6].Selections.length == 3 && n == 1) {
                    $(this).find('.selection1').text(changeLongName(arrayOfMatchOdds[i + 6].Selections[n + 1].SelectionName));
                    ...
                    $(this).find('.selection1').text(changeLongName(arrayOfMatchOdds[i + 6].Selections[n].SelectionName));
                    $(this).find('.odd1').text(arrayOfMatchOdds[i + 6].Selections[n].SelectionValue.toFixed(2));
                    $(this).find('.selection3').text(changeLongName(arrayOfMatchOdds[i + 6].Selections[n + 1].SelectionName));
                    $(this).find('.odd3').text(arrayOfMatchOdds[i + 6].Selections[n + 1].SelectionValue.toFixed(2));
                }
                else {
                    $(this).find('.selection1').text(changeLongName(arrayOfMatchOdds[i + 6].Selections[n + 1].SelectionName));
                    $(this).find('.odd1').text(arrayOfMatchOdds[i + 6].Selections[n + 1].SelectionValue.toFixed(2));
                    $(this).find('.selection3').text(changeLongName(arrayOfMatchOdds[i + 6].Selections[n + 2].SelectionName));
